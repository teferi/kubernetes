...
import (
	...
	fakeunversionedcatalog "k8s.io/kubernetes/pkg/client/typed/generated/catalog/unversioned/fake"
...
func (c *Clientset) Catalog() unversionedcatalog.CatalogInterface {
	return &fakeunversionedcatalog.FakeCatalog{&c.Fake}
}
