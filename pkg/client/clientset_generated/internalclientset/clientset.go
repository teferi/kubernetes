...
import (
	...
	unversionedcatalog "k8s.io/kubernetes/pkg/client/typed/generated/catalog/unversioned"
...
type Interface interface {
	...
	Catalog() unversionedcatalog.CatalogCoreInterface
}
...
type Clientset struct {
	...
	*unversionedcatalog.CatalogClient
}
...
// Catalog retrieves the CatalogClient
func (c *Clientset) Catalog() unversionedcatalog.CatalogCoreInterface {
...
func NewForConfig(c *restclient.Config) (*Clientset, error) {
	...
	clientset.CatalogClient, err = unversionedcatalog.NewForConfig(c)
	if err != nil {
		return &clientset, err
	}
...
func NewForConfigOrDie(c *restclient.Config) *Clientset {
	...
	clientset.CatalogClient = unversionedcatalog.NewForConfigOrDie(c)
...
func New(c *restclient.RESTClient) *Clientset {
	...
	clientset.CatalogClient = unversionedcatalog.New(c)
